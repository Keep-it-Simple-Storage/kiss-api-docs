...
Welcome to the KISS API documentation. This API allows you to integrate with Keep It Simple Storage for NFC lock access and property management.

## Two Audiences

### White-Label App Operators

You have your own tenant-facing mobile app and need to integrate with KISS for NFC lock access.
